...
public class SecondScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("image1", "myimage", get_scene_width(), get_scene_height());
		image1 = add_sprite_for_image(SEImage.for_resource("image1"));
		image1.move(0,0);

		rsc.prepare_image("image3", "myimage3", 0.05 * get_scene_width(), 0.05 * get_scene_height());
		image3 = add_sprite_for_image(SEImage.for_resource("image3"));
		image3.move(0.95 * get_scene_width(),0.90 * get_scene_height());
		...
		image2.move(0.95 * get_scene_width(), 0.85 * get_scene_height());
